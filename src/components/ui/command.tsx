...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      'flex w-full flex-col rounded-lg bg-card text-card-foreground',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div className="flex shrink-0 items-center border-b border-border/80 px-3">
